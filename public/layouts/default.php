...
<head>
    ...
    <meta name="description" content="Webiness PHP framework"/>
...
<?php echo WsLocalize::msg('Downloads'); ?></a>
            </li>

            <li class="uk-parent" data-uk-dropdown>
                <a href="#"><?php echo WsLocalize::msg('Documentation'); ?></a>
                <div class="uk-dropdown uk-dropdown-navbar">
                    <ul class="uk-nav uk-nav-navbar">
                        <li>
                            <a href="<?php echo WsUrl::link('site', 'intro'); ?>">
<?php echo WsLocalize::msg('Introduction'); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo WsUrl::link('site', 'guide'); ?>">
<?php echo WsLocalize::msg('Guide'); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo WsUrl::link('site', 'auth_guide'); ?>">
<?php echo WsLocalize::msg('Auth Guide'); ?></a>
                        </li>
                        <li>
                            <a target="_blank" href="<?php echo WsSERVER_ROOT.'/doc/index.html'; ?>">
<?php echo WsLocalize::msg('Class Reference'); ?></a>
                        </li>
                    </ul>
                </div>
            </li>
